...
\begin{enumerate}
    \item To get started, label the positive and negative terminals of the resistors and the ammeter based on the passive sign convention and how we've labeled the voltage source.
