...
\note{
    Make sure to instruct the students to do these parts sequentially, because later parts rely on the proofs of previous parts. These parts are derivations for some fundamental properties of Eigenspaces and Orthogonality.
}
...
\begin{enumerate}
    ...
    \item Show that A has all real eigenvalues.
        ...
        \sol{
            ...
            At this point, using what we have shown in part 1 of problem 3, we also have:
