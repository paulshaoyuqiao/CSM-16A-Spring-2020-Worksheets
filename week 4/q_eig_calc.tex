...
\note{
    This problem is supposed to be straightforward, so make sure to stress the technique used in part (1), and let the students work amongst themselves for the rest of the question.
    [Notice]: This problem focuses on the mechanics of solving eigenvalues and eigenvectors, more focus can be spent on other problems if you feel your students are comfortable with this process.
}
